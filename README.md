...
- tensorflow graphviz
same as tensorboard without tensorboard diplay a graph of the tf graph. 

Could be long if graph is complex. generate a nice pdf [tf graph viz](https://github.com/akimach/tfgraphviz)
